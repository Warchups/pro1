package com.pmm.simarro.pmdm_banco_llopischristian.bd;
...
import com.pmm.simarro.pmdm_banco_llopischristian.dao.ClienteDAO;
import com.pmm.simarro.pmdm_banco_llopischristian.dao.CuentaDAO;
import com.pmm.simarro.pmdm_banco_llopischristian.dao.MovimientoDAO;
...
public class MiBD extends SQLiteOpenHelper {
    ...
    private String sqlCreacionCajeros = "CREATE TABLE cajeros (_id INTEGER PRIMARY KEY AUTOINCREMENT, direccion STRING, lat FLOAT, lng FLOAT, zom INTEGER);";
    ...
    private void insercionDatos(SQLiteDatabase db){
        ...
        db.execSQL("INSERT INTO clientes(id, nif, nombre, apellidos, claveSeguridad, email) VALUES (4, '44444444D', 'Admin', 'Llopis', 'admin', 'admin@admin.es');");
